...
//     // Append a timestamp to the file name to avoid conflicts
...
//     // Create and save a new Note document in MongoDB
//     const newNote = new Note({
//       title,
//       description,
//       email,
//       pdfUrl: `/uploads/${req.file.filename}`, // Use the static path for serving the file
//     });
...
//       filePath: `/uploads/${req.file.filename}`, // Static path for client access
//     });
//   } catch (error) {
...
// // MongoDB connection
// const mongoURI = process.env.MONGO_URI || 'your_mongo_uri_here'; // Ensure to use your actual MongoDB URI
